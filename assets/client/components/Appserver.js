...
import ExpressionListSsr from './expression/ExpressionListSsr';
          ...
          <div className="container-app">
            ...
            >
                    ...
                    <Route path="/accueil" 
                      ...
                      data={data}/>} } 
                    />
                    <Route path="/ajout-texte" 
                      render={ (props) => { return <TextAddSrr {...props} 
                      data={data}/>} } 
                    />
                    <Route 
                      path="/texte-liste" 
                      render={ (props) => { return <TextList {...props} data={data}/>} } 
                    />
                    <Route 
                    ...
                    <Route 
                      ...
                      render={ (props) => { return <CategoryList {...props} data={data}/>} } 
                    />
                    <Route 
                    ...
                    <Route 
                      path="/texte/:id_texte" 
                      render={ (props) => { return <TextSsr {...props} 
                      data={data}/>} } 
                    />
                    {/* <SwipeableRoutes> */}
                      <Route 
                        path="/revision" 
                        render={ (props) => { return <RevisionSsr {...props} 
                        data={data} 
                        step={'text-list'}/>} } 
                      />
                      <Route 
                      ...
                      <Route 
                        ...
                        render={ (props) => { return <CustomSeriesList 
                        {...props} 
                        data={data} />} } 
                      />
                      <Route 
                      ...
                      <Route 
                        path="/expressions" 
                        render={ (props) => { return <ExpressionListSsr 
                        {...props} 
                        data={data} />} } 
                      />
                      <Route 
                        path="/series" 
                        render={ (props) => { return <SerieList 
                        {...props} 
                        data={data} />} } 
                      />
                    {/* </SwipeableRoutes> */}
