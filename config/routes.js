...
module.exports.routes = {
  ...
  'POST /save-expression-ajax': {controller: 'PostController', action: 'saveExpressionAjax', csrf: false},
  ...
  'POST /get-data-home-ajax': {controller: 'PostController', action: 'getDataHomeAjax', csrf: false},
  'POST /get-data-navbar-ajax': {controller: 'PostController', action: 'getDataNavbarAjax', csrf: false},
  'POST /update-histoserie-ajax': {controller: 'PostController', action: 'updateHistoserieAjax', csrf: false},
